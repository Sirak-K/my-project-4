...
# VIEW 4 A - LOGGED-IN - USER FEED / TIMELINE VIEW
@login_required
def user_feed(request):
    ...
    friend_posts = Post.objects.filter(author__in=friends).order_by('-timestamp')
...
# VIEW 4 B - LOGGED-IN - PROFILE VIEW
@login_required
