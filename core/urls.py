...
from . import views
from .views import CommentCreateView, PostDeleteView, PostCreateView, PostListView, PostDetailsView
...
urlpatterns = [
    ...
    path('post_details/<int:pk>/toggle-like/', views.toggle_like, name='toggle_like'),
